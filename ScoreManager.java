package com.example.q_learing2048;
...
public class ScoreManager {
    ...
    private void saveBestScoreToFile() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("src/main/resources/com/example/q_learing2048/BestScore.txt"))){
    ...
    private void getBestScoreFromFile() {
        try (BufferedReader reader = new BufferedReader(new FileReader("src/main/resources/com/example/q_learing2048/BestScore.txt"))){
